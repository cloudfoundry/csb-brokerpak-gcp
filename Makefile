...
export GSB_SERVICE_CSB_GOOGLE_MYSQL_PLANS = [{"name": "default","id": "eec62c9b-b25e-4e65-bad5-6b74d90274bf","description": "Default MySQL v8.0 10GB storage","display_name": "default","mysql_version": "MYSQL_8_0","storage_gb": 10,"tier": "db-n1-standard-2"}]
export GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS = [{"name": "default","id": "2875f0f0-a69f-4fe6-a5ec-5ed7f6e89a01","description": "Cloud Storage Bucket service with default configuration","display_name": "default"}]
