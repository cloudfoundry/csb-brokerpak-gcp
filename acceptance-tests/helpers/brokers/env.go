...
func (b Broker) env() []apps.EnvVar {
	...
	result = append(result,
		...
		apps.EnvVar{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "default","id": "2875f0f0-a69f-4fe6-a5ec-5ed7f6e89a01","description": "Cloud Storage Bucket service with default configuration","metadata":{"display_name": "default"}}]`},
	)
...
func (b Broker) releasedEnv() []apps.EnvVar {
	return []apps.EnvVar{
		...
		{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "private","id": "bbc4853e-8a63-11ea-a54e-670ca63cee0b","description": "Private Storage bucket","metadata":{"display_name": "Private"}},{"name": "public-read","id": "c07f21a6-8a63-11ea-bc1b-d38b123189cb","description": "Public-read Storage bucket","metadata":{"display_name": "Public Read"}}]`},
	}
}
...
func (b Broker) latestEnv() []apps.EnvVar {
	return []apps.EnvVar{
		...
		{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "default","id": "2875f0f0-a69f-4fe6-a5ec-5ed7f6e89a01","description": "Cloud Storage Bucket service with default configuration","metadata":{"display_name": "default"}}]`},
	}
}
