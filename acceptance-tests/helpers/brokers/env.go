...
func (b Broker) env() []apps.EnvVar {
	...
	result = append(result,
		...
		apps.EnvVar{Name: "GSB_SERVICE_CSB_GOOGLE_MYSQL_PLANS", Value: `[{"name": "default","id": "eec62c9b-b25e-4e65-bad5-6b74d90274bf","description": "Default MySQL v8.0 10GB storage","display_name": "default","mysql_version": "MYSQL_8_0","storage_gb": 10,"tier": "db-n1-standard-2"}]`},
		apps.EnvVar{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "default","id": "2875f0f0-a69f-4fe6-a5ec-5ed7f6e89a01","description": "Cloud Storage Bucket service with default configuration","display_name": "default"}]`},
	)
...
func (b Broker) releasedEnv() []apps.EnvVar {
	return []apps.EnvVar{
		...
		{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "private","id": "bbc4853e-8a63-11ea-a54e-670ca63cee0b","description": "Private Storage bucket","display_name": "Private"},{"name": "public-read","id": "c07f21a6-8a63-11ea-bc1b-d38b123189cb","description": "Public-read Storage bucket","display_name": "Public Read"}]`},
	}
}
...
func (b Broker) latestEnv() []apps.EnvVar {
	return []apps.EnvVar{
		{Name: "GSB_SERVICE_CSB_GOOGLE_POSTGRES_PLANS", Value: `[{"name":"small","id":"5b45de36-cb90-11ec-a755-77f8be95a49d","description":"PostgreSQL with default version, shared CPU, minimum 0.6GB ram, 10GB storage","display_name":"small","tier":"db-f1-micro","storage_gb":10},{"name":"medium","id":"a3359fa6-cb90-11ec-bcb6-cb68544eda78","description":"PostgreSQL with default version, shared CPU, minimum 1.7GB ram, 20GB storage","display_name":"medium","tier":"db-g1-small","storage_gb":20},{"name":"large","id":"cd95c5b4-cb90-11ec-a5da-df87b7fb7426","description":"PostgreSQL with default version, minimum 8 cores, minimum 8GB ram, 50GB storage","display_name":"large","tier":"db-custom-8-8192","storage_gb":50}]`},
		{Name: "GSB_SERVICE_CSB_GOOGLE_MYSQL_PLANS", Value: `[{"name": "default","id": "eec62c9b-b25e-4e65-bad5-6b74d90274bf","description": "Default MySQL v8.0 10GB storage","display_name": "default","mysql_version": "MYSQL_8_0","storage_gb": 10,"tier": "db-n1-standard-2"}]`},
		{Name: "GSB_SERVICE_CSB_GOOGLE_STORAGE_BUCKET_PLANS", Value: `[{"name": "default","id": "2875f0f0-a69f-4fe6-a5ec-5ed7f6e89a01","description": "Cloud Storage Bucket service with default configuration","display_name": "default"}]`},
	}
}
